...
def classif_actions_by_mean():#chaque action a comme classif la moyenne des classifs de ses tiers, on ajoute toutes les classifs d'actions pour avoir l'histogramme final, on fait aussi l'histogramme par secteur
    ...
    if True:#SAMPLE=="all":
        ...
        bar1 = ax.bar(index, financements_publics, bar_width, label='Public')
        bar2 = ax.bar(index, financements_prives, bar_width, label='Privé', bottom=financements_publics)
        bar3 = ax.bar(index, financements_syndicats, bar_width, label='Syndicats',  bottom=np.array(financements_publics) + np.array(financements_prives))

        #bar3 = ax.bar(index, financements_syndicats, bar_width, label='Syndicats', bottom=financements_publics)

        ax.set_xlabel('Secteurs')
        ax.set_ylabel('Classe')
        ax.set_title('Répartition des classes par secteur industriel')
        ax.set_xticks(index)
        ax.set_xticklabels(secteurs,rotation=90, fontsize='small')
        ...
        ax.set_xlabel('Cibles')
        ax.set_ylabel('Classe')
        ax.set_title('Répartition des classes par cible')
        ax.set_xticks(index)
        ax.set_xticklabels(cibles,rotation=90, fontsize='small')
